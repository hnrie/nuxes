-- Iris compiled single-file module
-- Generated from the original Iris library.
-- All internal modules are embedded below.
...
local function __require(name)
    ...
    if not loader then
        error("Missing embedded module: " .. tostring(name), 2)
    end
    local result = loader()
    __cache[name] = result
    return result
...
__modules["lib.API"] = function()
local Types = __require("lib.Types")
...
__modules["lib.WidgetTypes"] = function()
--[=[
    @within Iris
    @type ID string
]=]
...
__modules["lib.init"] = function()
--!optimize 2
local Types = __require("lib.init.Types")
...
local Internal: Types.Internal = __require("lib.init.Internal")(Iris)
...
Iris.TemplateConfig = __require("lib.init.config")
...
Iris.ShowDemoWindow = __require("lib.init.demoWindow")(Iris)

__require("lib.init.widgets")(Internal)
__require("lib.init.API")(Iris)

return Iris

end

__modules["lib.widgets.Image"] = function()
local Types = __require("lib.Types")
...
__modules["lib.widgets.Combo"] = function()
local Types = __require("lib.Types")
...
__modules["lib.widgets.Plot"] = function()
local Types = __require("lib.Types")
...
__modules["lib.widgets.init"] = function()
local Types = __require("lib.widgets.Types")
...
return function(Iris: Types.Internal)
    ...
    __require("lib.widgets.init.Root")(Iris, widgets)
    __require("lib.widgets.init.Window")(Iris, widgets)

    __require("lib.widgets.init.Menu")(Iris, widgets)

    __require("lib.widgets.init.Format")(Iris, widgets)

    __require("lib.widgets.init.Text")(Iris, widgets)
    __require("lib.widgets.init.Button")(Iris, widgets)
    __require("lib.widgets.init.Checkbox")(Iris, widgets)
    __require("lib.widgets.init.RadioButton")(Iris, widgets)
    __require("lib.widgets.init.Image")(Iris, widgets)

    __require("lib.widgets.init.Tree")(Iris, widgets)
    __require("lib.widgets.init.Tab")(Iris, widgets)

    __require("lib.widgets.init.Input")(Iris, widgets)
    __require("lib.widgets.init.Combo")(Iris, widgets)
    __require("lib.widgets.init.Plot")(Iris, widgets)

    __require("lib.widgets.init.Table")(Iris, widgets)
end

end

__modules["lib.widgets.Text"] = function()
local Types = __require("lib.Types")
...
__modules["lib.widgets.Tree"] = function()
local Types = __require("lib.Types")
...
__modules["lib.widgets.RadioButton"] = function()
local Types = __require("lib.Types")
...
__modules["lib.widgets.Format"] = function()
local Types = __require("lib.Types")
...
__modules["lib.widgets.Tab"] = function()
local Types = __require("lib.Types")
...
__modules["lib.widgets.Button"] = function()
local Types = __require("lib.Types")
...
__modules["lib.widgets.Checkbox"] = function()
local Types = __require("lib.Types")
...
__modules["lib.widgets.Root"] = function()
local Types = __require("lib.Types")
...
__modules["lib.widgets.Table"] = function()
local Types = __require("lib.Types")
...
__modules["lib.widgets.Menu"] = function()
local Types = __require("lib.Types")
...
__modules["lib.widgets.Input"] = function()
local Types = __require("lib.Types")
...
__modules["lib.widgets.Window"] = function()
local Types = __require("lib.Types")
...
__modules["lib.Types"] = function()
local WidgetTypes = __require("lib.WidgetTypes")
...
__modules["lib.Internal"] = function()
local Types = __require("lib.Types")
...
__modules["lib.demoWindow"] = function()
local Types = __require("lib.Types")
...
__modules["lib.PubTypes"] = function()
local Types = __require("lib.Types")
