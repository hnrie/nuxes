...
describe('chatCompletionStream', () => {
  ...
  it('does not emit ready tool call for incomplete or non-object json arguments', async () => {
    const chunks = [
      'data: {"id":"1","object":"chat.completion.chunk","model":"x","choices":[{"index":0,"delta":{"tool_calls":[{"index":0,"id":"call_1","type":"function","function":{"name":"web_search","arguments":"\\"not-object\\""}}]},"finish_reason":"tool_calls"}]}\n\n',
      'data: [DONE]\n\n',
    ];
    ...
    expect(events.includes('tool_ready')).toBe(false);
  });
});
